...
import static com.example.demo.Controller.ManagerController.*;


public class DateBDmanager {
    ...
    void initialize() throws SQLException {
        ...
        if( tableVariant.equalsIgnoreCase("SelectUsers")){
            ...
            try {
                ...
                col4.setText(postal_code);
                col5.setText(phone_number);
                col6.setText(number_of_employees);

                while (resultSet.next()) {
                    dataList.add(new StorageData(resultSet.getString(id), resultSet.getString(establishment_type), resultSet.getString(address),
                            resultSet.getString(postal_code), resultSet.getString(phone_number), resultSet.getString(number_of_employees)));
                }
                col1.setCellValueFactory(cellData -> cellData.getValue().column1Property());
                col2.setCellValueFactory(cellData -> cellData.getValue().column2Property());
                col3.setCellValueFactory(cellData -> cellData.getValue().column3Property());
